# Open Brain — Completed Phases (Archive)

**Date:** archive split out 2026-05-20
**Status:** Historical record of phases that have shipped. The active plan lives in [IMPLEMENTATION-PLAN-2026-04-17.md](./IMPLEMENTATION-PLAN-2026-04-17.md).
**Purpose:** keep the working plan small enough that AI agents and humans don't pay context cost for phases that are already done. Each phase below corresponds to a `phase-N-complete` git tag.

## How to use this archive

- **Looking for context on a shipped phase?** Find it here. The text is preserved as-shipped, including the original task lists and exit criteria, so the git tag + this file are a complete record.
- **Working on an active phase?** Read [IMPLEMENTATION-PLAN-2026-04-17.md](./IMPLEMENTATION-PLAN-2026-04-17.md) — its sections cover only the open work, with one-line stubs pointing back here for anything completed.
- **Decision Log + Known Blockers** still live in the active plan. They're cross-cutting and grow alongside new work.

The archived phases below are arranged chronologically as they originally appeared in the implementation plan.
